...
public class HomeInventory extends JFrame {
    ...
    JButton newButton = new JButton(new ImageIcon("C:\\Users\\Swapnil K\\Documents\\NetBeansProjects\\HomeInventory\\src\\main\\java\\com\\mycompany\\homeinventory\\img\\new.PNG"));
    JButton deleteButton = new JButton(new ImageIcon("C:\\Users\\Swapnil K\\Documents\\NetBeansProjects\\HomeInventory\\src\\main\\java\\com\\mycompany\\homeinventory\\img\\delete.PNG"));
    JButton saveButton = new JButton(new ImageIcon("C:\\Users\\Swapnil K\\Documents\\NetBeansProjects\\HomeInventory\\src\\main\\java\\com\\mycompany\\homeinventory\\img\\save.PNG"));
    JButton previousButton = new JButton(new ImageIcon("C:\\Users\\Swapnil K\\Documents\\NetBeansProjects\\HomeInventory\\src\\main\\java\\com\\mycompany\\homeinventory\\img\\previous.PNG"));
    JButton nextButton = new JButton(new ImageIcon("C:\\Users\\Swapnil K\\Documents\\NetBeansProjects\\HomeInventory\\src\\main\\java\\com\\mycompany\\homeinventory\\img\\next.PNG"));
    JButton printButton = new JButton(new ImageIcon("C:\\Users\\Swapnil K\\Documents\\NetBeansProjects\\HomeInventory\\src\\main\\java\\com\\mycompany\\homeinventory\\img\\print.PNG"));
    ...
    public HomeInventory() {
        ...
        Dimension bSize = new Dimension(80, 70);
        ...
        int n;
        try {
            inputFile = new BufferedReader(new FileReader("C:\\Users\\Swapnil K\\Documents\\NetBeansProjects\\HomeInventory\\src\\main\\java\\com\\mycompany\\homeinventory\\Inventory.txt"));
    ...
    private Date stringToDate(String s) {
        int m = Integer.valueOf(s.substring(0, 2)).intValue();
        int d = Integer.valueOf(s.substring(3, 5)).intValue();
        int y = Integer.valueOf(s.substring(6)).intValue();
...
// write combo box entries
    ...
    public void photoButtonActionPerformed(ActionEvent e) {
        JFileChooser openChooser = new JFileChooser();
        openChooser.setDialogType(JFileChooser.OPEN_DIALOG);
        openChooser.setDialogTitle("Open Photo File");
        openChooser.addChoosableFileFilter(new FileNameExtensionFilter("Photo Files", "jsp"));
    ...
    public void searchButtonActionPerformed(ActionEvent e) {
        ...
        i = 0;
        do {
            if (myInventory[i].description.substring(0, 1).equal(letterClicked)) {
                currentEntry = i + 1;
                showEntry(currentEntry);
                return;
            }
